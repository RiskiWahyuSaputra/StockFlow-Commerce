<section>
    <header>
        ...
        <p class="mt-1 text-sm leading-6 text-slate-600">
            {{ __('Perbarui nama, nomor telepon, dan email akun Anda.') }}
        </p>
    </header>
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="mt-2 text-sm text-slate-700">
                        ...
                        <button form="send-verification" class="text-sm font-medium text-brand-700 transition hover:text-brand-600 focus:outline-none">

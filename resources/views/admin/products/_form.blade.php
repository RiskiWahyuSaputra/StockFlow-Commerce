...
<form method="POST" action="{{ $isEdit ? route('admin.products.update', $product) : route('admin.products.store') }}" enctype="multipart/form-data" class="space-y-6">
    ...
    <section class="rounded-[1.8rem] border border-slate-200 bg-white p-6 shadow-sm">
        <div class="grid gap-4 lg:grid-cols-2">
            <div class="lg:col-span-2">
                <label for="name" class="text-sm font-semibold text-slate-900">Nama Produk</label>
            ...
            <div>
                <label for="category_id" class="text-sm font-semibold text-slate-900">Kategori</label>
            ...
            <div>
                ...
                <select id="status" name="status" class="mt-2 block w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 focus:border-slate-400 focus:outline-none focus:ring-0">
                    <option value="draft" @selected($statusValue === 'draft')>Draf</option>
                    ...
                    <option value="archived" @selected($statusValue === 'archived')>Arsip</option>
                </select>
            </div>

            <div>
                <label for="price" class="text-sm font-semibold text-slate-900">Harga</label>
            ...
            <div>
                <label for="stock" class="text-sm font-semibold text-slate-900">Stok</label>
            ...
            <div>
                <label for="low_stock_threshold" class="text-sm font-semibold text-slate-900">Batas Stok Menipis</label>
            ...
            <div>
                <label for="weight" class="text-sm font-semibold text-slate-900">Berat (gram)</label>
            ...
            <div>
                <label for="published_at" class="text-sm font-semibold text-slate-900">Tanggal Publikasi</label>
            ...
            <div class="lg:col-span-2">
                <label for="short_description" class="text-sm font-semibold text-slate-900">Deskripsi Singkat</label>
    ...
    <section class="rounded-[1.8rem] border border-slate-200 bg-white p-6 shadow-sm">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <p class="text-sm font-semibold uppercase tracking-[0.24em] text-slate-400">Gambar Produk</p>
        ...
        <div class="mt-6">
            <label for="images" class="text-sm font-semibold text-slate-900">Unggah Gambar</label>
